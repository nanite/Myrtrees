...
public interface MyrtreesBlockEntities {
    ...
    Supplier<BlockEntityType<WoodenBucketBlockEntity>> WOODEN_BUCKET = REGISTRY.register("wooden_bucket", () -> BlockEntityType.Builder.of(WoodenBucketBlockEntity::new, MyrtreesBlocks.WOODEN_BUCKET.get()).build(null));
}
