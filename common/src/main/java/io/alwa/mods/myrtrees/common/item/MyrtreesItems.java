...
public interface MyrtreesItems {
    ...
    Supplier<Item> RUBBERWOOD_SLAB = REGISTRY.register("rubberwood_slab", () -> new BlockItem(MyrtreesBlocks.RUBBERWOOD_SLAB.get(), new Item.Properties().tab(Myrtrees.TAB)));
    Supplier<Item> RUBBERWOOD_STAIRS = REGISTRY.register("rubberwood_stairs", () -> new BlockItem(MyrtreesBlocks.RUBBERWOOD_STAIRS.get(), new Item.Properties().tab(Myrtrees.TAB)));
